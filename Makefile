CXX := cl
LD := link
CXXFLAGS := /FS /Zi /utf-8 /EHs- /EHa- /wd4530 /DTARGET_WINDOWS /MD /O2 /nologo /GL /Gy /Oi- /GR- /GS- /DPIN_CRT=1 /Zc:threadSafeInit- /Zc:sizedDealloc- /wd5208 /FIinclude/msvc_compat.h \
...
X86LDFLAGS := /DEBUG /LTCG /DLL /EXPORT:main  /NODEFAULTLIB /NOLOGO /INCREMENTAL:NO /IGNORE:4210 /IGNORE:4049 /DYNAMICBASE /NXCOMPAT /MACHINE:x86 /ENTRY:Ptrace_DllMainCRTStartup@12 /OPT:REF Pin/ia32/runtime/pincrt/crtbeginS.obj
...
X64INCLUDES := -I"Pin/source/include/pin" \
			-I"Pin/source/include/pin/gen" \
			-I"Pin/extras/stlport/include" \
			-I"Pin/extras" \
			-I"Pin/extras/crt/include/kernel/uapi" \
			...
			-I"Pin/source/tools/InstLib" \
			-I"Pin/source/tools/Utils" \
			-I"Pin/extras/xed-intel64/include/xed" \
			-I"Pin/extras/components/include" \
			-I"Pin/extras/crt/include/kernel/uapi/asm-x86" \
			-I"Pin/extras/crt/include/arch-x86_64" \
			-I"Pin/extras/crt" \
			-I"Pin/extras/crt/include" \
			-I"Pin/extras/stlport/include/stl" \
			-I"C:\Program Files (x86)\Windows Kits\10\Include\10.0.22621.0\shared" \
			-I"C:\Program Files (x86)\Windows Kits\10\Include\10.0.22621.0\um"
X64LDFLAGS := /DEBUG /LTCG /DLL /EXPORT:main  /NODEFAULTLIB /NOLOGO /INCREMENTAL:NO /IGNORE:4210 /IGNORE:4049 /DYNAMICBASE /NXCOMPAT /MACHINE:x64 /ENTRY:Ptrace_DllMainCRTStartup /OPT:REF Pin/intel64/runtime/pincrt/crtbeginS.obj
...
OBJ_DIR := obj-$(arch)
CXX_SOURCES = image.cpp call.cpp calltrack.cpp args.cpp
